...
export type Retailer = {
  ...
  stock: boolean;
  link: string;
  tag?: "Best Price" | "Top Rated";
};

export default function RetailerRow({ retailer }: { retailer: Retailer }) {
  return (
    <tr className="border-b">
      <td className="p-8 font-medium">{retailer.name}</td>
      <td className="p-8">
        ${retailer.price}{" "}
      ...
      <td className="p-8">{retailer.reviews.toLocaleString()}</td>
      <td className="p-8">
        <span
